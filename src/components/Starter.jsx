...
import Background from './video/ocean.webp';
...
const Starter = () => {
  return (
    ...
    <p className='text-blue-400 font-bold italic p-4 text-xl'>Fait par Thomas Tetrel en React</p>
    <h1 className='md:text-7xl sm:text-6xl text-4xl font-bold md:p-6'>Retrouvez les prévisions</h1>
    <div className='flex justify-center items-center'>
        <p className='md:text-5xl sm:text-4xl text-xl font-bold'>Rapide, Précis </p>
        <Typed
